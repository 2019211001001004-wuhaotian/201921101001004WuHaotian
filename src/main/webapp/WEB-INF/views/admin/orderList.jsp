			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.Wuhaotian.model.Order o=(com.Wuhaotian.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.Wuhaotian.dao.UserDao userDao=new com.Wuhaotian.dao.UserDao();
						...
						<%
							...
							String paymentType=com.Wuhaotian.model.Payment.findByPaymentId(con,n);
							 %>
